...
export default function Kapcsolat () {
    return (
        <Template>
            <NextSeo
                title={"Kapcsolat"}
                description={"Várjuk egy megbeszélésre Budapest belvárosában található irodánkban."}
            />
            <div className="mt-28 w-full px-16">
                <h1 className="font-bold text-3xl">Kapcsolat</h1>
                <p>
                    Várjuk egy megbeszélésre Budapest belvárosában található irodánkban.
                </p>
                <div
                    className="grid grid-cols-1 lg:grid-cols-4 lg:gap-4  mt-6 h-[70vh] border border-gray-200 rounded-xl overflow-hidden">
